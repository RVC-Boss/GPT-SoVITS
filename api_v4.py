...
def get_tts_wav(
    ...
    audio_bytes = pack_audio(io.BytesIO(), (audio_opt * 32767).astype(np.int16), sr, media_type)
    yield audio_bytes.getvalue()

def pack_audio(audio_bytes, data, rate, media_type)->io.BytesIO:
    if media_type == "ogg":
...
async def tts_endpoint(request: Request):
    ...
    return handle(
        ...
        json_post_raw.get("how_to_cut","cut1"),
        ...
        json_post_raw.get("media_type", "ogg"),
    )
