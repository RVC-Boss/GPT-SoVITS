...
如果你是 Windows 用户（已在 win>=10 上测试），可以下载[下载整合包](https://huggingface.co/lj1995/GPT-SoVITS-windows-package/resolve/main/GPT-SoVITS-beta0706fix1.7z?download=true)，解压后双击 go-webui.bat 即可启动 GPT-SoVITS-WebUI。
